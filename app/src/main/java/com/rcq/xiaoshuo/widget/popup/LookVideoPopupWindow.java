...
public class LookVideoPopupWindow extends BasePopup {
    private View layout;
    private View content;

    public LookVideoPopupWindow(Activity context) {
        super(context);
    }

    @Override
    public View setContextView(LayoutInflater inflater) {
        View view = inflater.inflate(R.layout.popup_lookvideo,null);
