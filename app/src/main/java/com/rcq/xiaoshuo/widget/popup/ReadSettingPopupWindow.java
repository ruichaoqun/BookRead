...
public class ReadSettingPopupWindow extends BasePopup {
    private View layout;
    private View content;

    public ReadSettingPopupWindow(Activity context) {
        super(context);
    }

    @Override
    public View setContextView(LayoutInflater inflater) {
        View view = inflater.inflate(R.layout.popup_read_setting,null);
