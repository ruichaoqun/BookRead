package com.rcq.xiaoshuo.widget.pictureimage;
...
public class PictureImageView extends AppCompatImageView {
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(PictureImageView pinchImageView);
    }
    ...
    public PictureImageView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(PictureImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(PictureImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(PictureImageView.this);
            }
            return true;
        }
    });
